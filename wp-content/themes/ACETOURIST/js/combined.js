...
;(function ($) {
    ...
    var mfp, MagnificPopup = function () {
        }, _isJQ = !!(window.jQuery), _prevStatus, _window = $(window), _body, _document, _prevContentType, _wrapClasses,
        _currPopupType;
...
(function (t) {
    ...
    function n(t) {
        function n(t) {
            if ("string" == typeof t && (t = document.querySelector(t)), t && "object" == typeof t && t.nodeType) {
                ...
                var m = h.paddingLeft + h.paddingRight, y = h.paddingTop + h.paddingBottom,
                    g = h.marginLeft + h.marginRight, v = h.marginTop + h.marginBottom,
                    _ = h.borderLeftWidth + h.borderRightWidth, b = h.borderTopWidth + h.borderBottomWidth, L = p && o,
                    E = e(n.width);
    ...
    var n = t.getSize, o = t.getStyleProperty, r = t.EventEmitter, s = document.defaultView,
    ...
    e(i.prototype, r.prototype), i.prototype._create = function () {
        ...
        var t = a(this.element), e = this.layout.options, i = e.isOriginLeft, n = e.isOriginTop,
    ...
    var a = t.Outlayer, h = a.Item, p = t.docReady, u = t.EventEmitter, f = t.eventie, d = t.getSize,
        c = t.matchesSelector, l = t.document, m = t.console, y = t.jQuery, g = function () {
    ...
    s.prototype = {
        _init: function () {
            ...
            if (e("body").find(n.$tooltip).length !== 0) {
                ...
                var r = null, i = e(t).width(), s = n.elProxyPosition, o = n.$tooltip.outerWidth(false),
                    u = n.$tooltip.innerWidth() + 1, a = n.$tooltip.outerHeight(false);
                if (n.$elProxy.is("area")) {
                    var f = n.$elProxy.attr("shape"), l = n.$elProxy.parent().attr("name"),
                        c = e('img[usemap="#' + l + '"]'), h = c.offset().left, p = c.offset().top,
                ...
                var A = 0, O = 0, M = 0, _ = parseInt(n.options.offsetY), D = parseInt(n.options.offsetX),
    ...
    e.fn[r] = function () {
        ...
        if (this.length === 0) {
            ...
            if (typeof t[0] === "string") {
                ...
                var o = [], u = t[0] && typeof t[0].multiple !== "undefined",
...
jQuery(document).ready(function () {
    ...
    jQuery(window).scroll(function () {
        ...
        if (jQuery(this).scrollTop() > 200) {
            jQuery('#toTop').stop().css({opacity: 0.3, "visibility": "visible"}).animate({
                "visibility": "visible",
                "bottom": "-5px"
            }, {duration: 1000, easing: "easeOutExpo"});
        } else if (jQuery(this).scrollTop() == 0) {
            jQuery('#toTop').stop().css({opacity: 0, "visibility": "hidden"}).animate({
                "bottom": "0px",
                "visibility": "hidden"
